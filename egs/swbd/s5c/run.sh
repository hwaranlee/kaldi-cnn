...
set -e # exit on error
has_fisher=false
local/swbd1_data_download.sh /data1/database/LDC/LDC97S62
...
local/swbd1_data_prep.sh /data1/database/LDC/LDC97S62
...
fisher_dirs= #"/export/database/LDC/LDC2004T19/fe_03_p1_tran/ /export/corpora3/LDC/LDC2005T19/fe_03_p2_tran/"
...
local/eval2000_data_prep.sh /data1/database/LDC/LDC2002S09/hub5e_00 /data1/database/LDC/LDC2002T43
