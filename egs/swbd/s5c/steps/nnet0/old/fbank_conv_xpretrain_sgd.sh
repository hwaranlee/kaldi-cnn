...
ConvolutionComponent in-height=40 in-width=21 in-channel=1 kernel-height=40 kernel-width=6 stride=1 group=100 out-height=1 out-width=16 learning-rate=$initial_learning_rate param-stddev=$conv_stddev1 bias-stddev=$bias_stddev weight-decay=$weight_decay
MaxpoolComponent in-height=1 in-width=16 in-channel=100 pool-height-dim=1 pool-width-dim=2 pool-channel-dim=1
ConvolutionComponent in-height=1 in-width=8 in-channel=100 kernel-height=1 kernel-width=5 stride=1 group=200 out-height=1 out-width=4 learning-rate=$initial_learning_rate param-stddev=$conv_stddev2 bias-stddev=$bias_stddev weight-decay=$weight_decay
MaxpoolComponent in-height=1 in-width=4 in-channel=200 pool-height-dim=1 pool-width-dim=2 pool-channel-dim=1
EOF
