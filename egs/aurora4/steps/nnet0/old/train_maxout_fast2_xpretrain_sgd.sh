...
AffineComponent input-dim=$lda_dim output-dim=$pnorm_input_dim learning-rate=$initial_learning_rate param-stddev=$stddev bias-stddev=$bias_stddev
...
(
echo AffineComponent input-dim=$pnorm_output_dim output-dim=$pnorm_input_dim learning-rate=$initial_learning_rate param-stddev=$stddev bias-stddev=$bias_stddev
echo MaxpoolComponent in-height=1 in-width=1 in-channel=$pnorm_input_dim pool-height-dim=1 pool-width-dim=1 pool-channel-dim=$[$pnorm_input_dim/$pnorm_output_dim]
echo NormalizeComponent dim=$pnorm_output_dim
)>> $dir/nnet.config
done

(
echo AffineComponent input-dim=$pnorm_output_dim output-dim=$num_leaves learning-rate=$initial_learning_rate param-stddev=0 bias-stddev=0
