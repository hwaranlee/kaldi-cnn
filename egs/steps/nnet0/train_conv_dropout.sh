...
if [ ! -f $dir/.init_valid ]; then
 $cmd $parallel_opts JOB=1:$nj_valid $dir/log/compute_prob_valid.0.JOB.log nnet-compute-prob $test_mdl ark:$egs_dir/valid_egs.JOB.ark || exit 1;
 run.pl -pe smp 8 JOB=1:10 exp/nnet-fbank/tri3b_cnn_multi/log/compute_prob_validd.0.JOB.log nnet-compute-prob exp/nnet-fbank/tri3b_cnn_multi/0.mdl ark:exp/nnet-fbank/egs/valid_egs.JOB.ark || exit 1;
