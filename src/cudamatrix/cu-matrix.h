...
class CuMatrixBase {
  ...
  */
  ...
  void EqualElementMask(const CuMatrixBase<Real> &mat, CuMatrix<Real> *mask) const;
		...
		void Maxpool_prop(int32 in_height, int32 in_width, int32 pool_height_dim, int32 pool_width_dim, int32 pool_channel_dim, bool overlap, bool overlap2D, CuMatrixBase<Real> *out) const;
		...
		void ModPermuteChannel(int32 comp_idx, int32 num_component, int32 in_height, int32 in_width, CuMatrixBase<Real> *container, bool fromCompToContainer);
